...
// ================= SUB MENU ICON & LOGO HELPERS =================
const CATEGORY_ICON_MAP = {
  // Mobile / Smartphones
  "galaxy phone": "/assets/category-icons/galaxyphone.svg",
  "galaxyphone": "/assets/category-icons/galaxyphone.svg",
  "google pixel": "/assets/category-icons/pixelphone.svg",
  "googlepixel": "/assets/category-icons/pixelphone.svg",
  "pixel phone": "/assets/category-icons/pixelphone.svg",
  "pixelphone": "/assets/category-icons/pixelphone.svg",
  "iphones": "/assets/category-icons/iphone.svg",
  "iphone": "/assets/category-icons/iphone.svg",
  "smart phone": "/assets/category-icons/smartphone.svg",
  "smartphone": "/assets/category-icons/smartphone.svg",
  "smartphones": "/assets/category-icons/smartphone.svg",
  "mobiles": "/assets/category-icons/smartphone.svg",
  "mobile": "/assets/category-icons/smartphone.svg",
  "feature phone": "/assets/category-icons/featurephone.svg",
  "featurephone": "/assets/category-icons/featurephone.svg",
  "feature phones": "/assets/category-icons/featurephone.svg",

  // Audio / Sound
  "soundbar": "/assets/category-icons/soundbar.svg",
  "soundbars": "/assets/category-icons/soundbar.svg",
  "speakers": "/assets/category-icons/speakers.svg",
  "speaker": "/assets/category-icons/speakers.svg",
  "bluetooth speaker": "/assets/category-icons/speakers.svg",
  "party speaker": "/assets/category-icons/partyspeaker.svg",
  "partyspeaker": "/assets/category-icons/partyspeaker.svg",
  "party speakers": "/assets/category-icons/partyspeaker.svg",
  "home theatre": "/assets/category-icons/hometheatre.svg",
  "hometheatre": "/assets/category-icons/hometheatre.svg",
  "home theater": "/assets/category-icons/hometheatre.svg",
  "earbuds": "/assets/category-icons/earbuds.svg",
  "earbud": "/assets/category-icons/earbuds.svg",
  "tws earbuds": "/assets/category-icons/earbuds.svg",
  "earphones": "/assets/category-icons/earphones.svg",
  "earphone": "/assets/category-icons/earphones.svg",
  "headphones": "/assets/category-icons/headphones.svg",
  "headphone": "/assets/category-icons/headphones.svg",
  "headphones & headsets": "/assets/category-icons/headphones.svg",
  "headsets": "/assets/category-icons/headphones.svg",
  "neckband": "/assets/category-icons/neckband.svg",
  "neckbands": "/assets/category-icons/neckband.svg",

  // Accessories
  "back case": "/assets/category-icons/backcase.svg",
  "backcase": "/assets/category-icons/backcase.svg",
  "back cases": "/assets/category-icons/backcase.svg",
  "mobile covers": "/assets/category-icons/mobilecase.svg",
  "mobile cover": "/assets/category-icons/mobilecase.svg",
  "mobilecase": "/assets/category-icons/mobilecase.svg",
  "covers": "/assets/category-icons/mobilecase.svg",
  "chargers": "/assets/category-icons/charger.svg",
  "charger": "/assets/category-icons/charger.svg",
  "power bank": "/assets/category-icons/powerbank.svg",
  "powerbank": "/assets/category-icons/powerbank.svg",
  "power banks": "/assets/category-icons/powerbank.svg",
  "tempered glass": "/assets/category-icons/temperedglass.svg",
  "temperedglass": "/assets/category-icons/temperedglass.svg",
  "screen protector": "/assets/category-icons/temperedglass.svg",
  "usb cables": "/assets/category-icons/usbcable.svg",
  "usb cable": "/assets/category-icons/usbcable.svg",
  "usbcable": "/assets/category-icons/usbcable.svg",
  "cables": "/assets/category-icons/usbcable.svg",
  "otg adaptors": "/assets/category-icons/otg.svg",
  "otg adaptor": "/assets/category-icons/otg.svg",
  "otg adapters": "/assets/category-icons/otg.svg",
  "otg": "/assets/category-icons/otg.svg",

  // Tablets & iPad
  "tab": "/assets/category-icons/tab.svg",
  "tabs": "/assets/category-icons/tab.svg",
  "tablets": "/assets/category-icons/tab.svg",
  "tablet": "/assets/category-icons/tab.svg",
  "ipad": "/assets/category-icons/ipad.svg",
  "ipads": "/assets/category-icons/ipad.svg",
  "tablet with call facility": "/assets/category-icons/tabcalling.svg",
  "tablet with call": "/assets/category-icons/tabcalling.svg",
  "tablets with call facility": "/assets/category-icons/tabcalling.svg",
  "tabcalling": "/assets/category-icons/tabcalling.svg",
  "tablet without call facility": "/assets/category-icons/tabwifi.svg",
  "tablet without call": "/assets/category-icons/tabwifi.svg",
  "tablets without call facility": "/assets/category-icons/tabwifi.svg",
  "tabwifi": "/assets/category-icons/tabwifi.svg",
  "smart pen": "/assets/category-icons/smartpen.svg",
  "smartpen": "/assets/category-icons/smartpen.svg",
  "stylus": "/assets/category-icons/smartpen.svg",

  // Laptops & Computers
  "laptop": "/assets/category-icons/laptop.svg",
  "laptops": "/assets/category-icons/laptop.svg",
  "desktop": "/assets/category-icons/desktop.svg",
  "desktops": "/assets/category-icons/desktop.svg",
  "keyboards": "/assets/category-icons/keyboard.svg",
  "keyboard": "/assets/category-icons/keyboard.svg",

  // TV & Entertainment
  "qled": "/assets/category-icons/qled.svg",
  "qled tv": "/assets/category-icons/qled.svg",
  "led hd": "/assets/category-icons/ledhd.svg",
  "led hd tv": "/assets/category-icons/ledhd.svg",
  "ledhd": "/assets/category-icons/ledhd.svg",
  "ultra hd": "/assets/category-icons/ultrahd.svg",
  "ultra hd tv": "/assets/category-icons/ultrahd.svg",
  "ultrahd": "/assets/category-icons/ultrahd.svg",
  "tv remote": "/assets/category-icons/tvremote.svg",
  "tvremote": "/assets/category-icons/tvremote.svg",
  "remotes": "/assets/category-icons/tvremote.svg",
  "playstation": "/assets/category-icons/playstation.svg",
  "gaming console": "/assets/category-icons/playstation.svg",

  // Appliances
  "air conditioner": "/assets/category-icons/ac.svg",
  "ac": "/assets/category-icons/ac.svg",
  "air conditioners": "/assets/category-icons/ac.svg",
  "split ac": "/assets/category-icons/splitac.svg",
  "splitac": "/assets/category-icons/splitac.svg",
  "inverter ac": "/assets/category-icons/inverterac.svg",
  "inverterac": "/assets/category-icons/inverterac.svg",
  "window ac": "/assets/category-icons/windowac.svg",
  "windowac": "/assets/category-icons/windowac.svg",
  "stabilizer": "/assets/category-icons/stabilizer.svg",
  "stabiliser": "/assets/category-icons/stabilizer.svg",
  "stabilizers": "/assets/category-icons/stabilizer.svg",
  "washing machine": "/assets/category-icons/washingmachine.svg",
  "washingmachine": "/assets/category-icons/washingmachine.svg",
  "washing machines": "/assets/category-icons/washingmachine.svg",
  "refrigerator": "/assets/category-icons/refrigerator.svg",
  "refrigerators": "/assets/category-icons/refrigerator.svg",
  "fridge": "/assets/category-icons/refrigerator.svg",
  "dishwasher": "/assets/category-icons/dishwasher.svg",
  "dishwashers": "/assets/category-icons/dishwasher.svg",

  // Wearables & Gadgets
  "smartwatch": "/assets/category-icons/smartwatch.svg",
  "smart watches": "/assets/category-icons/smartwatch.svg",
  "smart watch": "/assets/category-icons/smartwatch.svg",
  "smart watches & accessories": "/assets/category-icons/smartwatch.svg",
  "gadgets": "/assets/category-icons/gadgets.svg",
  "gadget": "/assets/category-icons/gadgets.svg"
};

const getCategoryIconPath = (catName) => {
  if (!catName) return "/assets/category-icons/default.svg";
  const cleanName = catName.toLowerCase().trim();
  if (CATEGORY_ICON_MAP[cleanName]) return CATEGORY_ICON_MAP[cleanName];
  const stripped = cleanName.replace(/[^a-z0-9]/g, "");
  if (CATEGORY_ICON_MAP[stripped]) return CATEGORY_ICON_MAP[stripped];

  // Specific multi-word / keyword matches
  if (cleanName.includes("without call") || cleanName.includes("wifi")) return "/assets/category-icons/tabwifi.svg";
  if (cleanName.includes("with call") || cleanName.includes("calling")) return "/assets/category-icons/tabcalling.svg";
  if (cleanName.includes("ipad")) return "/assets/category-icons/ipad.svg";
  if (cleanName.includes("tablet") || cleanName.includes("tab")) return "/assets/category-icons/tab.svg";
  if (cleanName.includes("keyboard")) return "/assets/category-icons/keyboard.svg";
  if (cleanName.includes("cover") || cleanName.includes("mobilecase")) return "/assets/category-icons/mobilecase.svg";
  if (cleanName.includes("otg")) return "/assets/category-icons/otg.svg";
  if (cleanName.includes("party")) return "/assets/category-icons/partyspeaker.svg";
  if (cleanName.includes("hometheatre") || cleanName.includes("home theatre")) return "/assets/category-icons/hometheatre.svg";
  if (cleanName.includes("playstation") || cleanName.includes("gaming")) return "/assets/category-icons/playstation.svg";
  if (cleanName.includes("pen") || cleanName.includes("stylus")) return "/assets/category-icons/smartpen.svg";
  if (cleanName.includes("dish")) return "/assets/category-icons/dishwasher.svg";
  if (cleanName.includes("phone")) return "/assets/category-icons/smartphone.svg";
  if (cleanName.includes("case")) return "/assets/category-icons/backcase.svg";
  if (cleanName.includes("charge")) return "/assets/category-icons/charger.svg";
  if (cleanName.includes("headphone") || cleanName.includes("headset")) return "/assets/category-icons/headphones.svg";
  if (cleanName.includes("earbud")) return "/assets/category-icons/earbuds.svg";
  if (cleanName.includes("speaker") || cleanName.includes("sound")) return "/assets/category-icons/speakers.svg";
  if (cleanName.includes("cable") || cleanName.includes("usb")) return "/assets/category-icons/usbcable.svg";
  if (cleanName.includes("tv")) return "/assets/category-icons/qled.svg";
  if (cleanName.includes("ac") || cleanName.includes("conditioner")) return "/assets/category-icons/ac.svg";
  if (cleanName.includes("watch")) return "/assets/category-icons/smartwatch.svg";

  return "/assets/category-icons/default.svg";
};
...
const BRAND_LOGO_MAP = {
  ...
  "dell": "/assets/brand-logos/dell.webp",
...
const getBrandLogoPath = (brandInput) => {
  ...
  if (BRAND_LOGO_MAP[cleanName]) return BRAND_LOGO_MAP[cleanName];
  const stripped = cleanName.replace(/[^a-z0-9]/g, "");
  if (BRAND_LOGO_MAP[stripped]) return BRAND_LOGO_MAP[stripped];
  return null;
};
...
export default function Header() {
  ...
  const desktopHideTimeout = useRef(null);

  const openDesktopMenu = (index) => {
    if (desktopHideTimeout.current) {
      clearTimeout(desktopHideTimeout.current);
      desktopHideTimeout.current = null;
    }
    setOpenDesktopCategory(index);
  };

  const closeDesktopMenuDelayed = () => {
    if (desktopHideTimeout.current) clearTimeout(desktopHideTimeout.current);
    desktopHideTimeout.current = setTimeout(() => {
  ...
  function renderDesktopSuggestionItem(item, idx) {
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div
            className={`text-[14px] font-medium leading-snug line-clamp-2 ${isActive ? 'text-red-700' : 'text-gray-800 group-hover:text-gray-900'
              }`}
          >
            {item.name || 'Unnamed'}
          </div>
              ...
              >
                ...
                >
                  ...
                  {hasChildren && (
                    ...
                    >
                      <FiChevronRight
                        className={`text-white rounded-full p-1 transition-transform duration-200 bg-[#d32424] ${isOpen ? "rotate-90" : "rotate-0"
                          }`}
                        size={18}
                      />
                    </button>
...
*/}
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 lg:gap-4 shrink-0">
            ...
            <div className="hidden lg:flex items-center gap-1 text-sm px-1.5 py-0.5 border-2 border-primary rounded-2xl">
              <Link href="https://stores.sathyamobiles.com/" className="flex">
                ...
                >
                  ...
                  {cat.subcategories?.length > 0 && (
                    <div
                      ...
                      onMouseEnter={() => openDesktopMenu(index)}
                      onMouseLeave={closeDesktopMenuDelayed}
                      className={`absolute left-1/2 -translate-x-1/2 top-full mt-1.5 transition-all duration-200 bg-white text-gray-800 rounded-b-xl rounded-t-sm shadow-2xl border border-gray-200 z-50 p-0 overflow-hidden w-[1180px] max-w-[95vw] ${
                        openDesktopCategory === index
                          ? "opacity-100 visible"
                    ...
                    >
                      <div className="flex flex-row h-full">
                        ...
                        {/* ---------------- 1. LEFT SIDE: SHOP BY CATEGORY ---------------- */}
                        <div className="w-[240px] shrink-0 bg-white flex flex-col justify-between border-r border-gray-100 h-full">
                          <div className="flex-1 flex flex-col min-h-0">
                            <div className="px-4 py-2.5 text-[11px] font-extrabold tracking-wider text-red-600 uppercase border-b border-gray-100 bg-gray-50/50 shrink-0">
                              SHOP BY CATEGORY
                            </div>
                            <div className="flex-1 overflow-y-auto custom-scrollbar py-1">
                              {cat.subcategories.map((sub) => {
                                const iconPath = getCategoryIconPath(sub.category_name);
                                return (
                                  <Link
                                    key={sub._id || sub.category_slug}
                                    href={`/category/${sub.category_slug}`}
                                    className="flex items-center justify-between px-4 py-2 hover:bg-red-50 hover:text-red-700 text-red-600 transition-all group/subitem"
                                  >
                                    <div className="flex items-center gap-3 min-w-0">
                                      <img
                                        src={iconPath}
                                        alt={sub.category_name}
                                        className="w-5 h-5 object-contain shrink-0 group-hover/subitem:scale-110 transition-transform"
                                      />
                                      <span className="text-[13px] font-bold truncate text-red-600 group-hover/subitem:text-red-700">
                                        {sub.category_name}
                                      </span>
                                    </div>
                                    <FiChevronRight className="w-3.5 h-3.5 text-red-400 group-hover/subitem:text-red-600 shrink-0 ml-1" />
                                  </Link>
                                );
                              })}
                            </div>
                          ...
                          <div className="border-t border-gray-100 px-4 py-3 bg-gray-50/30 shrink-0">
                            <Link
                              href={`/category/${cat.category_slug}`}
                              className="text-[13px] font-bold text-red-600 hover:text-red-700 hover:underline flex items-center justify-between group/viewall"
                            >
                              <span>View All {cat.category_name}</span>
                              <FiChevronRight className="w-4 h-4 text-red-600 group-hover/viewall:translate-x-0.5 transition-transform" />
                            </Link>
                          </div>
                        </div>

                        {/* ---------------- 2. MIDDLE AREA: SUBCATEGORY BRANDS & TOP BRANDS ---------------- */}
                        <div className="flex-1 flex flex-col justify-between p-4 bg-white min-w-0 h-full">

                          {/* Top: Subcategory Columns Grid */}
                          <div className="flex-1 overflow-y-auto max-h-[250px] pr-2 custom-scrollbar">
                            <div className="grid grid-cols-3 gap-5">
                              {cat.subcategories.map((sub) => {
                                const subBrandsList = Array.isArray(sub.brands) ? sub.brands : [];

                                return (
                                  <div key={sub._id || sub.category_slug} className="flex flex-col">
                                    <Link
                                      href={`/category/${sub.category_slug}`}
                                      className="text-[12px] font-extrabold uppercase tracking-wide text-red-600 hover:text-red-700 mb-2 truncate block"
                                    >
                                      {sub.category_name}
                                    </Link>
                                    {subBrandsList.length > 0 && (
                                      <ul className="space-y-1">
                                        {subBrandsList.map((bItem, bIdx) => {
                                          const bName = typeof bItem === "string" ? bItem : (bItem.brand_name || bItem.name);
                                          const bSlug = typeof bItem === "object" ? (bItem.brand_slug || bItem._id) : bName.toLowerCase();
                                          return (
                                            <li key={bIdx}>
                                              <Link
                          ...
                          {/* Bottom: TOP BRANDS */}
                          {(() => {
                            const catBrands = Array.isArray(cat.brands) ? cat.brands : [];

                            // Filter ONLY brands that exist in backend cat.brands AND have a matching logo image
                            const validTopBrands = catBrands
                              .map((b) => {
                                const logoPath = getBrandLogoPath(b);
                                const bName = typeof b === "string" ? b : (b.brand_name || b.name);
                                const bSlug = typeof b === "object" ? (b.brand_slug || b._id) : bName.toLowerCase();
                                return logoPath ? { brand_name: bName, brand_slug: bSlug, logoPath, original: b } : null;
                              })
                              .filter(Boolean);

                            if (validTopBrands.length === 0) return null;

                            const visibleBrands = validTopBrands.slice(0, 10);
                            const extraCount = validTopBrands.length - visibleBrands.length;

                            return (
                              <div className="shrink-0 pt-2.5 border-t border-gray-100">
                                <div className="text-[11px] font-extrabold uppercase tracking-wider text-red-600 mb-2">
                                  TOP BRANDS
                                </div>
                                  ...
                                  {visibleBrands.map((brand, bIdx) => (
                                    ...
                                    >
                                      <img
                                        ...
                                        className="max-h-5 max-w-[66px] object-contain group-hover/brandcard:scale-105 transition-transform"
                                      />
                                    </Link>
                                  ))}
                                  {extraCount > 0 && (
                                    <Link
                                      href={`/category/${cat.category_slug}`}
                                      className="text-[12px] font-bold text-red-600 hover:underline shrink-0 whitespace-nowrap px-2"
                                    >
                                      +{extraCount} more &gt;
                                    </Link>
                                  )}
                        ...
                        {/* ---------------- 3. RIGHT SIDE: BANNER IMAGE ---------------- */}
                        <div className="w-[270px] shrink-0 p-2.5 bg-gray-50/80 flex items-center justify-center border-l border-gray-100 h-full">
                          <Link
                            href={`/category/${cat.category_slug}`}
                            className="w-full h-full block relative group/banner overflow-hidden rounded-xl"
                          >
                            <img
                              src={getMenuBannerPath(cat.category_name, cat.category_slug)}
                              alt={cat.category_name}
                              className="w-full h-full object-cover group-hover/banner:scale-105 transition-transform duration-300 rounded-xl"
                            />
                          </Link>
                        </div>
          ...
          <div className="bg-white rounded-lg p-8 w-96 max-w-full relative">
            ...
            <form onSubmit={handleAuthSubmit} className="space-y-4">
              ...
              {activeTab === "register" && (
                <>
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500 ${errors?.register?.name ? "border-red-500" : ""
                      }`}
                  />
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500 ${errors?.[activeTab]?.email ? "border-red-500" : ""
                  }`}
              />
              ...
              {activeTab === "register" && (
                <>
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500 ${errors?.register?.mobile ? "border-red-500" : ""
                      }`}
                  />
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500 ${errors?.[activeTab]?.password ? "border-red-500" : ""
                  }`}
                minLength={6}
              />
